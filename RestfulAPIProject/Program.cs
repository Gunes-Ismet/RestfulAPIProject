...
builder.Services.AddAuthentication(options =>
{
    ...
    .AddJwtBearer(options2 =>
    {
        ...
        options2.TokenValidationParameters = new TokenValidationParameters
        {
            ...
            // Security Key doðrulamasý için SymmetricSecurityKey nesnesi aracýlýðý ile mevcut keyi belirtiyoruz
            IssuerSigningKey = new SymmetricSecurityKey(key),

            // Uygulamadaki token'ýn Audience deðerini belirledik (Audience : Eriþebilecek kimlikler)
            ValidateAudience = false,

            // Uygulamadaki token'ýn issuer deðerini belirledik (Issuer : Token deðerini daðýtacak kiþiler)
